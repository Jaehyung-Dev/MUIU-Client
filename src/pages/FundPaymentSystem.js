...
const FundPaymentSystem = () => {
  ...
  useEffect(() => {
    ...
    const fetchPostData = async () => {
      try {
          const response = await axios.get(`https://www.xn--api-248mu45ca3z.site/api/fund/post/${postId}`, {
            headers: {
  ...
  const savePaymentRecord = async () => {
    try {
      ...
      await axios.post(`https://www.xn--api-248mu45ca3z.site/api/fund/payment`, {
        postId,            // 결제 대상 게시글 ID
        amount: totalAmount,
      ...
      if (window.Naver && window.Naver.Pay) {
        ...
        naverPayBtn.addEventListener('click', () => {
          oPay.open({
              ...
              returnUrl: "https://www.xn--hz2b60wa3n.site/fund-payment-success" 
            });
          });
        }
      };
          ...
          tossPayBtn.addEventListener('click', () => {
            try {
              tossPayments.requestPayment('카드', {
                ...
                successUrl: 'https://www.xn--hz2b60wa3n.site/fund-payment-success',
                failUrl: 'https://www.xn--hz2b60wa3n.site/fund-payment',
              });
            } catch (error) {
